...
mod headings {
    use std::borrow::Cow;
    use super::response::{CodeGrantResponse, BasicErrorResponse};
...
mod server {
    ...
    use super::response::{CodeGrantResult, CodeGrantResponse, BasicErrorResponse};
    use std::sync::Arc;
    use tokio::sync::Mutex;
    use serde::Deserialize;
    use super::headings::{Headings, ToHeadings};
